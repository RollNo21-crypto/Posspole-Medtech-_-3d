...
export const SolutionsSection = () => {
  ...
  const solutionSteps = [
    {
      number: 1,
      icon: <Heart size={deviceType === 'mobile' ? 20 : 24} />,
      title: "Better Patient Outcomes",
      description: "AI-assisted imaging and robotic surgeries for safer, more precise care.",
      color: "#4f46e5", // indigo-600
    },
    {
      number: 2,
      icon: <Brain size={deviceType === 'mobile' ? 20 : 24} />,
      title: "Smart Clinical Decisions",
      description: "AI and predictive analytics reduce errors and enable personalized treatments.",
    ...
    },
    {
      ...
      description: "Minimally invasive tools reduce operation time and recovery duration.",
      color: "#2563eb", // blue-600
    },
    {
      number: 4,
      icon: <Globe size={deviceType === 'mobile' ? 20 : 24} />,
      title: "Global Care Access",
      description: "Telemedicine and remote diagnostics reach underserved areas worldwide.",
      color: "#0891b2", // cyan-600
    },
    {
      number: 5,
      icon: <PieChart size={deviceType === 'mobile' ? 20 : 24} />,
      title: "Lower Costs",
      description: "Improved efficiency reduces long-term expenses for providers and patients.",
      color: "#0d9488", // teal-600
    },
    {
      number: 6,
      icon: <LineChart size={deviceType === 'mobile' ? 20 : 24} />,
      title: "Real-Time Monitoring",
      description: "Wearables and smart implants enable proactive health management.",
