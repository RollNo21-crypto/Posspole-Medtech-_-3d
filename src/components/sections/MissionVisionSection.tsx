        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-16">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <InfoCard 
              title="Our Vision"
              icon={<Eye size={24} />}
              description="To humanize surgical and clinical care through intelligent, accessible medical technologies that empower clinicians, improve outcomes, and ensure no patient is left behind. At Posspole Medtech, we envision a future where cutting-edge innovation meets compassion—where AI, robotics, and digital platforms enhance—not replace—human care"
            ...
            <InfoCard 
              title="Our Mission"
              icon={<Target size={24} />}
              description="To design and deliver intelligent medical technologies that enhance surgical precision,
streamline care delivery, and expand access to life-saving innovations for every healthcare
setting—from top-tier hospitals to remote clinics."
              bgColor="bg-gradient-to-br from-primary-100 to-primary-200/70"
              delay={0.2}
            />
            ...
            <InfoCard 
              title="Our History"
              icon={<Clock size={24} />}
              description="Posspole MedTech curates and brings breakthrough medical
technologies—spanning AI diagnostics, robotic surgery, and
personalized healthcare—to the global market. Focused on accessibility, precision, and innovation, it partners with global startups to scale life-saving solutions that transform clinical care and patient outcomes."
          ...
          <div className="lg:col-span-7 grid grid-cols-1 gap-6">
            ...
            >
              <h3 className="text-2xl font-display font-bold text-neutral-900 mb-6">Ready to transform healthcare with us?</h3>
              <p className="text-neutral-700 mb-6 leading-relaxed">
                Join Posspole MedTech in bringing the world’s most advanced medical
innovations to those who need them most. Whether you're a healthcare
provider, innovator, or impact partner—let’s build the future of care,
together.
              </p>
              <motion.a
                href="#contact"
